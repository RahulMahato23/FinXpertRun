...
# Define the Dashboard service specific secrets
...
MONGO_URI="mongodb+srv://Rahul23:uu0dnAbXAp2MnRWc@cluster0.3m2oh.mongodb.net/expensio-dashboard?retryWrites=true&w=majority&appName=Cluster0" # OVERWRITE
PORT="3000"

# Create the Dashboard service specific secret
kubectl create secret generic $DASHBOARD_SECRET_NAME \
  --namespace=$NAMESPACE \
