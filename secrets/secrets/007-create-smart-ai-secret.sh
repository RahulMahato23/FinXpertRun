...
SMART_AI_SECRET_NAME="smart-ai-secret"

# Define the Smart AI service specific secrets
...
MONGO_URI="mongodb+srv://Rahul23:uu0dnAbXAp2MnRWc@cluster0.3m2oh.mongodb.net/expensio-smartai?retryWrites=true&w=majority&appName=Cluster0" # OVERWRITE
PORT="3000"

# Create the Smart AI service specific secret
kubectl create secret generic $SMART_AI_SECRET_NAME \
  --namespace=$NAMESPACE \
