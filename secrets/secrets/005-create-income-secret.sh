...
INCOME_SECRET_NAME="income-secret"
SERVICE_NAME="income"

# Define the Income service specific secrets
...
MONGO_URI="mongodb+srv://Rahul23:uu0dnAbXAp2MnRWc@cluster0.3m2oh.mongodb.net/expensio-income?retryWrites=true&w=majority&appName=Cluster0" # OVERWRITE
PORT="3000"

# Create the Income service specific secret
kubectl create secret generic $INCOME_SECRET_NAME \
  --namespace=$NAMESPACE \
