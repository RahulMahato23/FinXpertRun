...
FINANCIAL_DATA_SECRET_NAME="financial-data-secret"

# Define the Financial Data service specific secrets
...
MONGO_URI="mongodb+srv://Rahul23:uu0dnAbXAp2MnRWc@cluster0.3m2oh.mongodb.net/expensio-financial?retryWrites=true&w=majority&appName=Cluster0" # OVERWRITE
PORT="3000"

# Create the Financial Data service specific secret
kubectl create secret generic $FINANCIAL_DATA_SECRET_NAME \
  --namespace=$NAMESPACE \
